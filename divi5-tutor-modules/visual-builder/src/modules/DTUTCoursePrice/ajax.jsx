const MyAccountMemo = {};
const data = DTUTCoursePriceVisualBuilderData;

function Ajax(text = "") {
    // Use empty string as a valid cache key
    const key = text;
    const course_id = (DiviSettingsData?.post?.type === 'courses') ? DiviSettingsData?.post?.id : 0;
    ...
    formData.append('context', 'DTUTCoursePrice');
