                        ...
                        <div class="tutor-accordion-item-body-content">
                            <ul class="tutor-course-content-list">
                                <?php while ($topic_contents->have_posts()) : ?>
                                    ...
                                    $is_locked        = ! ($is_enrolled || $is_preview || $is_public_course || $is_privileged_user);
                                    ?>
                                    <li class="tutor-course-content-list-item">
                                        <div class="tutor-d-flex tutor-align-center">
                                            ...
                                            <h5 class="tutor-course-content-list-item-title">
                                                ...
                                                if ($is_enrolled || $is_privileged_user || (get_post_meta($course_id, '_tutor_is_public_course', true) == 'yes' && ! tutor_utils()->is_course_purchasable($course_id))) {
                                                    ...
                                                    echo wp_kses_post(apply_filters('tutor_course/contents/lesson/title', $lesson_title, get_the_ID()));
                                                }
                                                ?>
                                            </h5>
                                        </div>
